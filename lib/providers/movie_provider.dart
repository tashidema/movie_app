...
class MovieProvider extends ChangeNotifier {
  ...
  List<MovieModel> get trending => _movies.length > 4 ? _movies.sublist(0, 4) : _movies;

  List<MovieModel> get latestMovies => _movies.length > 4 ? _movies.sublist(_movies.length - 4) : _movies;
